/*
    <PL / SQL>
    PROCEDUERE LANGUAGE EXTENSION TO SQL
    
    오라클 자체에 내장되어있는  절자척 언어
...
BEGIN    
    ...
    DBMS_OUTPUT.PUT_LINE('ENAME :'  || ENAME);
    DBMS_OUTPUT.PUT_LINE('SAL :' || SAL);
    DBMS_OUTPUT.PUT_LINE('JCODE :' || SAL);
    DBMS_OUTPUT.PUT_LINE('DTITLE :' || SAL);
END;
/
...
--BEGIN
--  사용자라 입력한 사번의 사번, 이름 , 부서명, 근무국가코드 조회 후 각 변수에 대입
--
