/*
    ...
    TCL(TRANSACTION트랜잭션 제어) : COMMIT, ROLLBACK
    
    <DML>
    : 데이터 조작 언어
    
    테이블 값을 삽입(INSERT하거나, 수정(UPDATE)하거나, 삭제(DELETE) 하는구문)
...
INSERT INTO EMPLOYEE VALUES(900, '이소근', '880912-1011123', 'SG8809@naver.com', '01045611879',
...
VALUES(901, '최지원', '440701-1234571', 'J7', SYSDATE);
...
AS (SELECT EMP_ID, EMP_NAME, DEPT_CODE, HIRE_DATE
    FROM EMPLOYEE
    WHERE 1 = 0); -- 어떤 조건을 넣어도 상관 없으나 성립이 되지 않는 조건을 삽입
...
--성동일 사원의 급여를 700만원, 보너스를 0.2로 변경
...
/*
    ...
    [표현식]
    DELETE FROM 테이블명
    [WHERE  조건] --> WHERE 절 제시안하면 전체행 다 삭제됨
